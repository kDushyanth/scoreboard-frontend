        ...
        <Card sx={{ width: 600, padding: 2 }}>
            <Grid container >
                ...
                <Grid item xs={6} display="flex" flexDirection="column" alignItems="center" >
                    <Box sx={teamScore}>
                        <Typography variant="h6">
                            {matchDetails.matchDetails.footballTeamScores[0].name} {" - "} {matchDetails.matchDetails.footballTeamScores[0].goals}
                        </Typography>
                    </Box>
                ...
                <Grid item xs={6} display="flex" flexDirection="column" alignItems="center" >
                    <Box sx={teamScore}>
                        <Typography variant="h6">
                            {matchDetails.matchDetails.footballTeamScores[1].name} {" - "} {matchDetails.matchDetails.footballTeamScores[1].goals}
                        </Typography>
                    </Box>
